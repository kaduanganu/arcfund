...
let campaignAddressBefore = "";

if (!history.state) {
    history.replaceState({ page: "home", index: 0 },
        "",
        ""
      );
}
...
window.nextCampaignPage = function () {
      ...
      historyIndex++;
      history.pushState(
        { page: "home", index: historyIndex, currentCampaignPageNya: currentCampaignPage},
        "",
        ""
      );*/
...
function showScreen1() {
  /*history.pushState(
    { page: "landing", index: -1, currentCampaignPageNya: 0 },
    "",
    ""
  );*/
...
historyIndex++;
history.pushState(
    { page: cempen, index: historyIndex, currentCampaignPageNya: currentCampaignPage, campaignAddressNya: campaignAddressBefore },
    "",
    ""
);
};

window.hideMODAL = async function (cempen) {
  hideChainlist();
  hideCategorylist();
  hideCategorylist2();
  hideCategorylist3();
    ...
    function (event) {
      ...
      //return;
        ...
        //this.alert("before - "+beforePage+" xxxxxx now - "+currentPage+" xxxxxx now - "+(nextIndex)+" - "+(historyIndex));
          ...
          else if (page === "viewCampaign") {
            openCampaignGROUPNOPUSH(campaignAddressNya);
          }
          else if (page === "home") {
            if (currentPage === "createCampaign") {
              showHomeScreenINDEXNOPUSH();
            }
        ...
        /*
          ...
          this.alert("BACK <<< before - "+beforePage+" xxxxxx now - "+currentPage+" xxxxxx now - "+(nextIndex)+" - "+(historyIndex));
          ...
          this.alert("FORWARD >>> before - "+beforePage+" xxxxxx now - "+currentPage+" xxxxxx now - "+(nextIndex)+" - "+(historyIndex));
          ...
          else if (beforePage === "viewCampaign") {
            firstHistory("");
            openCampaignGROUP(campaignAddressBefore);
          }

          else if (beforePage === "showChain") {
            firstHistory("");
            showChainlist();
          }
          else if (beforePage === "showChainviewCampaign") {
            firstHistory("viewCampaign");
            showChainlist();
          }
          else if (beforePage === "showCategory") {
            firstHistory("createCampaign");
            showCategorylist();
          }
          else if (beforePage === "showCategory2") {
            firstHistory("");
            showCategorylist2();
          }
          else if (beforePage === "showCategory3") {
            firstHistory("");
            showCategorylist3();
          }
          else {
...
window.openCampaign = async function (
    campaignAddress
      ...
      campaignAddressBefore = campaignAddress;

      /*beforePage = currentPage;
      currentPage = "viewCampaign";
      historyIndex++;
      history.pushState(
        { page: "viewCampaign", index: historyIndex, currentCampaignPageNya: currentCampaignPage, campaignAddressNya: campaignAddressBefore},
        "",
        ""
      );*/
...
async function showScreen2() {
  ...
  /*history.pushState(
    { page: "home", index: 0, currentCampaignPageNya: currentCampaignPage },
    "",
    ""
  );*/
...
<button
  ...
  <div class="flex-row" style="align-items:center; text-align:center;">
    ...
    <button id="homebutton"
      class="btn_op_rev2P" style="font-size:1.1rem;"
      onclick="showHomeScreenRefreshPLUS();"
    >
      close
    </button>
  </div>
...
window.showHomeScreenINDEX = function () {
      ...
      //historyIndex++;
      //history.pushState(
        //{ page: "", index: historyIndex, currentCampaignPageNya: currentCampaignPage },
        //"",
        //""
      //);
  ///
...
window.showHomeScreenINDEXNOPUSH = function () {
      //beforePage = currentPage;
      //currentPage = "";
      //historyIndex++;
      //history.pushState(
...
window.showChainlist = function () {
  ...
  if (currentPage === "viewCampaign") {
      ...
      historyIndex++;
      history.pushState(
        { page: "showChainviewCampaign", index: historyIndex, currentCampaignPageNya: currentCampaignPage },
        "",
        ""
      );*/
  }
      ...
      historyIndex++;
      history.pushState(
        { page: "showChain", index: historyIndex, currentCampaignPageNya: currentCampaignPage },
        "",
        ""
      );*/
  }
...
window.showChainlistPLUS = function () {

  if (document.getElementById("campaign-details-screen").style.display === "none")
  {
    ///firstHistory("showChain");
  }
  else
  {
    ///firstHistory("showChainviewCampaign");
  }
  showChainlist();
}
window.showChainlistPLUSPLUS = function () {
  ///firstHistory("showChainviewCampaign");
  showChainlist();
}

window.showHomeScreenRefreshPLUS = function () {
  ///
  firstHistory("home");
...
window.hideChainlistPLUS = function () {
  ///firstHistory("home");
  hideChainlist();
};

window.hideChainlistPLUSPLUS = function () {
  ///firstHistory("home");
  hideChainlist();
};
...
window.showCategorylist = function () {
      ...
      historyIndex++;
      history.pushState(
        { page: "showCategory", index: historyIndex, currentCampaignPageNya: currentCampaignPage },
        "",
        ""
      );*/
...
window.showCategorylistPLUS = function () {
  ///firstHistory("showCategory");
  showCategorylist();
}
...
window.hideCategorylistPLUS = function () {
  ///firstHistory("home");
  hideCategorylist();
};
...
window.showCategorylist2 = function () {
      ...
      historyIndex++;
      history.pushState(
        { page: "showCategory2", index: historyIndex, currentCampaignPageNya: currentCampaignPage },
        "",
        ""
      );*/
...
window.showCategorylist2PLUS = function () {
  ///firstHistory("showCategory2");
  showCategorylist2();
}
...
window.hideCategorylist2PLUS = function () {
  ///firstHistory("home");
  hideCategorylist2();
};
...
window.showCategorylist3 = function () {
      ...
      historyIndex++;
      history.pushState(
        { page: "showCategory3", index: historyIndex, currentCampaignPageNya: currentCampaignPage },
        "",
        ""
      );*/
...
window.showCategorylist3PLUS = function () {
  ///firstHistory("showCategory2");
  showCategorylist3();
}
...
window.hideCategorylist3PLUS = function () {
  ///firstHistory("home");
  hideCategorylist3();
};
